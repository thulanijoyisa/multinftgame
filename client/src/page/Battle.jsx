...
import { attack, attackSound, defense, defenseSound, player01 as Player01Icon,
        player02 as Player02Icon } from '../assets';    
import {playAudio} from '../utils/animation';

const Battle = () => {
    const {contract, gameData, walletAddress, showAlert, setShowAlert, battleGround,
            setErrorMessage, player1Ref, player2Ref} = useGlobalContext();
