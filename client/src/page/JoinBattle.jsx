...
const handleClick = async  (battleName) => {
  ...
  try {
    ...
    setShowAlert( {sattus: true, type: 'success', message: `Joining ${battleName}`})
  } catch (error) {
  ...
  return (
    <>
     ...
     <div className={styles.joinContainer}>
      ...
      ? gameData.pendingBattles.filter((battle) => !battle.players.includes(walletAddress) && battle.battleStatus !== 1)
              .map((battle, index) => (
