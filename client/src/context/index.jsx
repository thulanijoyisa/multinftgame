...
export const GlobalContextProvider = ({children}) => {
    //interact and connect with our smartcontract
    ...
    useEffect(() => {
        if(step !== -1 && contract){
            ...
            createEventListeners({
                navigate, contract, provider,walletAddress,
                setShowAlert,battleName,setBattleName,setUpdateGameData,
    ...
    return (
        <GlobalContext.Provider value={{
            contract, walletAddress, showAlert, setShowAlert,updateCurrentWalletAddress,
            battleName,setBattleName, gameData, battleGround,setBattleGround, errorMessage, 
