...
const GameInfo = () => {
  ...
  const handleBattleExit = async () => {
    ...
    try {
      ...
      setShowAlert({status: true, type: 'info', message: `You are quitting the ${battleName}`})
    } catch (error) {
  ...
  return (
    ...
    <div className={styles.gameInfoIconBox}>
      <div className={`${styles.gameInfoIcon} ${styles.flexCenter}`}
    ...
    <div className={`${styles.gameInfoSidebar} ${toggleSidebar ? 'translate-x-0 ' : 'translate-x-full'} 
         ...
         <div className='flex flex-col'>
          <div className={styles.gameInfoSidebarCloseBox}>
            <div className={`${styles.flexCenter} ${styles.gameInfoSidebarCloseBox}`} onClick= {() => setToggleSideBar(false)}>
